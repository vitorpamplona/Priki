...
public class AddEscortWikiwordTransaction extends PrikiTransaction {
    ...
    public AddEscortWikiwordTransaction(String user, String wikiword) {
        this.user = user;
